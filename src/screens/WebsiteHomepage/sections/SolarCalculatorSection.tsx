            ...
            <div className="relative rounded-[20px] sm:rounded-[28px] border border-[#d7eadd] bg-white shadow-[0_18px_60px_rgba(0,0,0,0.08)]">
              ...
              <div className="relative p-4 sm:p-6 md:p-10 flex flex-col gap-3 sm:gap-6">
                  ...
                  <div className="flex flex-wrap items-center justify-end md:justify-start gap-2 w-full md:w-auto min-w-0">
                    <div className="relative flex justify-end md:justify-start">
                      <button
                        ...
                        className={`rounded-full border text-[12px] sm:text-sm font-semibold transition-all flex items-center justify-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#00a63e] focus-visible:ring-offset-2 min-h-[48px] min-w-[48px] sm:min-h-[44px] sm:min-w-0 px-4 py-2.5 sm:py-2 active:scale-[0.98] ${
                          calcResult
                    ...
                    {showShareOptions && calcResult && (
                      <div
                        ...
                        className="absolute top-full mt-2 left-0 right-auto sm:left-auto sm:right-8 bg-white border border-gray-200 rounded-lg shadow-xl py-1 z-[100] w-[136px] sm:w-[148px] max-w-[calc(100vw-2rem)]"
                      >
                        <button
                          type="button"
                          role="menuitem"
                          ...
                          className="w-full px-2.5 py-2.5 sm:py-1.5 min-h-[44px] text-left hover:bg-gray-50 flex items-center gap-2 text-[11px] sm:text-[12px] focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#00a63e]"
                        >
                        ...
                        <button
                          ...
                          className="w-full px-2.5 py-2.5 sm:py-1.5 min-h-[44px] text-left hover:bg-gray-50 flex items-center gap-2 text-[11px] sm:text-[12px] focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#00a63e]"
                        >
                          <Copy className="w-3.5 h-3.5 text-gray-600 flex-shrink-0" aria-hidden />
                          Copy Link
                        </button>
                      </div>
                    )}
                ...
                {calcResult && primaryStats.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-center gap-4 text-center min-h-[220px] py-8 sm:py-12">
                    <div className="inline-block px-3 py-1 bg-gradient-to-r from-[#dcfce7] to-[#ddefff] rounded-full">
                      <span className="text-[11px] sm:text-[13px] font-semibold text-[#017c54] font-['Urbanist']">Instant results</span>
                    </div>
                    {hasAttemptedCalculation ? (
                      ...
                      <>
                        <div className="w-16 h-16 bg-[#dcfce7] rounded-full flex items-center justify-center" aria-hidden>
                          <Calculator className="w-8 h-8 text-[#017c54]" />
                        </div>
                        <h3 className="font-['Urbanist'] font-bold text-[18px] sm:text-[20px] text-[#0a0a0a] mb-2">
                          Ready to calculate
                        </h3>
