                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <div className="relative">
                      <button
                        ...
                        className={`min-h-[44px] px-3 sm:px-4 py-2 rounded-full border text-[10px] sm:text-sm font-semibold transition-all flex items-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#00a63e] focus-visible:ring-offset-2 ${
                          calcResult
                            ? "bg-[#eef2ff] border-[#dcdafc] text-[#312e81] hover:bg-[#e0e7ff] cursor-pointer"
                            : "bg-gray-100 border-gray-200 text-gray-400 cursor-not-allowed"
                        }`}
                      >
                        <Share2 className="w-3 h-3 sm:w-4 sm:h-4" aria-hidden />
                        Share
                      </button>
                    {showShareOptions && calcResult && (
                      <div className="absolute top-full mt-2 right-0 bg-white border border-gray-200 rounded-lg shadow-lg py-2 z-50 min-w-[200px]">
                        <button
                          ...
                          className="w-full px-4 py-2.5 text-left hover:bg-gray-50 flex items-center gap-3 text-sm min-h-[44px] focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#00a63e]"
                        >
